interface Nomnoml {
  ...
  render(graphics: Graphics, config: Config, compartment: Compartment, setFont: SetFont): void
  renderSvg(code: string, docCanvas?: HTMLCanvasElement): string
  parse(source: string): any
  intermediateParse(source: string): AstRoot
  transformParseIntoSyntaxTree(entity: AstRoot): Compartment
  layout(measurer: Measurer, config: Config, ast: Compartment): Compartment
