...
nomnoml.parse = function (source: string): ParsedDiagram {
...
nomnoml.intermediateParse = function (source: string): AstRoot {
	return nomnomlCoreParser.parse(source)
}

nomnoml.transformParseIntoSyntaxTree = function (entity: AstRoot): Compartment {
